...
// Route for a doctor to create a diagnosis
router.post('/', [authMiddleware, authorize('doctor')], createDiagnosis);

// Route for a patient or their care team to view diagnoses
router.get('/patient/:patientId', [authMiddleware, authorize('patient', 'doctor')], getPatientDiagnoses);

// Routes for a doctor to update or delete a diagnosis they created
router
  .route('/:id')
